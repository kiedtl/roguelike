    ...
    return LevelConfig{
        ...
        .tunneler_opts = .{
            ...
            .initial_tunnelers = &[_]tunneler.TunnelerOptions.InitialTunneler{
                .{ .start = Coord.new(15, 7), .width = 0, .height = 1, .direction = .East },
                .{ .start = Coord.new(WIDTH - 15, 7), .width = 1, .height = 0, .direction = .South },
                .{ .start = Coord.new(WIDTH - 14, HEIGHT - 8), .width = 0, .height = 1, .direction = .West },
                .{ .start = Coord.new(15, HEIGHT - 7), .width = 1, .height = 0, .direction = .North },
            },
        },
        .prefab_chance = 60,
